...
class RedliningValidator:
    ...
    def __init__(self, unpacked_dir, original_docx, verbose=False, author="Assistant"):
    ...
    def validate(self):
        ...
        try:
            ...
            # Redlining validation is only needed if tracked changes by the configured author have been used.
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Remove the configured author's tracked changes from both documents
            self._remove_tracked_changes_by_author(original_root)
            self._remove_tracked_changes_by_author(modified_root)
    ...
    def _remove_tracked_changes_by_author(self, root):
        ...
        # Unwrap content in w:del elements where author is the configured author
