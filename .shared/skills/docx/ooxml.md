...
### Validation Rules
The validator checks that the document text matches the original after reverting changes authored by the configured author (default: `Assistant`). This means:
